...
class ParticleFilter(object):
    ...
    def __init__(
        ...
        """
        self.resample_fn = resample_fn or systematic_resample
        ...
        self.weights_not = np.ones(n_particles)
    ...
    def update(self, observed=None, **kwargs):
        ...
        self.particles = self.noise_fn(self.dynamics_fn(self.particles, **kwargs), **kwargs)

        # # hypothesise observations
        # self.particles = self.noise_fn(self.particles, **kwargs)
        # self.hypotheses = self.observe_fn(self.particles, **kwargs)
        ...
        if self.internal_weight_fn is not None:
            ...
            internal_weights = np.clip(internal_weights, 1e-100, 1e100)
